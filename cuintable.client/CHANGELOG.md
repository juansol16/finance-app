...
- Cree un proyecto de Angular con ng: `ng new cuintable.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`cuintable.client.esproj`).
