  ...
  template: `
    <div class="min-h-screen flex items-center justify-center p-4 app-shell">
      ...
      <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="app-blob w-[32rem] h-[32rem] -top-32 -left-32 opacity-[0.22] animate-blob" style="background: radial-gradient(circle, #1d4ed8, transparent 70%);"></div>
        <div class="app-blob w-[28rem] h-[28rem] -bottom-32 -right-24 opacity-[0.18] animate-blob" style="background: radial-gradient(circle, #38bdf8, transparent 70%); animation-delay: -7s;"></div>
        <div class="app-blob w-[22rem] h-[22rem] top-1/3 right-1/4 opacity-[0.12] animate-blob" style="background: radial-gradient(circle, #2dd4bf, transparent 70%); animation-delay: -13s;"></div>
      </div>
      ...
      <div class="w-full max-w-sm relative z-10">
        ...
        <div class="glass-card p-7">
          <h2 class="text-xl font-bold text-white mb-1">{{ 'AUTH.LOGIN' | translate }} 👋</h2>
          <p class="text-sm text-slate-400 mb-5">{{ 'AUTH.WELCOME_BACK' | translate }}</p>
          ...
          <div class="space-y-4">
            ...
            <button class="btn btn-primary w-full mt-2 rounded-full" [disabled]="loading" (click)="login()">
          ...
          <p class="text-center mt-5 text-sm text-slate-500">
            ...
            <a class="text-blue-300 hover:text-blue-200 font-semibold transition-colors" routerLink="/register">
