  ...
  template: `
    <div class="flex min-h-[80vh] items-center justify-center">
      <div class="card w-full max-w-md bg-base-200 shadow-xl">
        <div class="card-body">
          <h2 class="card-title text-2xl justify-center mb-4">{{ 'AUTH.REGISTER' | translate }}</h2>
          ...
          <button class="btn btn-primary w-full mt-6" [disabled]="loading" (click)="register()">
          ...
          <p class="text-center mt-4 text-sm">
            ...
            <a class="link link-primary" routerLink="/login">{{ 'AUTH.LOGIN' | translate }}</a>
          </p>
        </div>
      </div>
    </div>
